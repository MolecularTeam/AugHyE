...
def data_root(model: str):
    ...
    elif model.startswith("esm3-300"):
        path = Path(snapshot_download(repo_id="EvolutionaryScale/esm3-300m-2024-12"))
    elif model.startswith("esm3-600"):
        path = Path(snapshot_download(repo_id="EvolutionaryScale/esm3-600m-2024-12"))
    else:
