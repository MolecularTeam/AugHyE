...
from esmv3.esm3.models.esmc import ESMC
from esmv3.esm3.models.function_decoder import FunctionTokenDecoder
from esmv3.esm3.models.vqvae import (
    StructureTokenDecoder,
    StructureTokenEncoder,
)
from esmv3.esm3.tokenization import get_model_tokenizers
from esmv3.esm3.utils.constants.esm3 import data_root
...
def ESMC_300M_202412(device: torch.device | str = "cpu"):
    ...
    state_dict = torch.load(
        data_root("esm3-300") / "data/weights/esm3_300m_2024_12_v0.pth",
        map_location=device,
    )
    model.load_state_dict(state_dict)
...
def ESMC_600M_202412(device: torch.device | str = "cpu"):
    ...
    state_dict = torch.load(
        data_root("esm3-600") / "data/weights/esm3_600m_2024_12_v0.pth",
        map_location=device,
    )
    model.load_state_dict(state_dict)
