...
from esmv3.esm3.tokenization import EsmSequenceTokenizer
from esmv3.esm3.utils import encoding
from esmv3.esm3.utils.constants.models import ESMC_600M
from esmv3.esm3.utils.decoding import decode_sequence
from esmv3.esm3.utils.sampling import _BatchedESMProteinTensor
...
class ESMC(nn.Module, ESMCInferenceClient):
    ...
    def from_pretrained(
        ...
        from esm3.pretrained import load_local_model
